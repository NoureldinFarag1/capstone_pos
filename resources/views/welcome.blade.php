        ...
        <div class="max-w-4xl mx-auto bg-white shadow-2xl rounded-2xl overflow-hidden">
            <div class="p-8 md:p-16 text-center">
                ...
                <div class="flex justify-center space-x-4">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="bg-blue-600 text-white px-8 py-3 rounded-lg hover:bg-blue-700 transition duration-300 shadow-md">
                            Go to Dashboard
                        </a>
                    @else
                        <a href="{{ route('login') }}" class="bg-blue-600 text-white px-8 py-3 rounded-lg hover:bg-blue-700 transition duration-300 shadow-md">
                            Log In
                        </a>
                    @endauth
                </div>
            ...
            <div class="bg-blue-50 p-4 text-center text-gray-500">
                © {{ date('Y') }} Local HUB. Connecting Communities.
            </div>
        </div>
    </div>
</body>
