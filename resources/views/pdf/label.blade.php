...
<head>
    ...
    <style>
        @page {
            size: 1.4409in 0.9843in;
            /* Set to the exact label size (36.5mm x 25mm) */
            margin: 0;
        }
        ...
        .item-name {
            ...
            margin: 0;
            padding-bottom: 2px;
            /* Space between name and barcode */
            max-height: 14px;
        ...
        .barcode {
            width: 1.2in;
            /* Adjusted barcode width */
            height: 0.35in;
            /* Slightly reduced height */
            object-fit: cover;
            /* Adjust to cover and avoid empty spaces */
            margin: 0;
        }
        ...
        .item-code {
            ...
            margin: 0;
            padding-top: 1px;
            /* Space between barcode and item code */
        }
        ...
        .pricing {
            ...
            padding-top: 2px;
            /* Space between item code and pricing */
            margin-top: 1px;
        }
        ...
        .brand-name {
            ...
            margin: 0;
            padding-top: 1px;
            /* Space between brand name and item name */
        }
    </style>
</head>
