    ...
    <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
        ...
        <div class="flex gap-4">
            <a href="{{ route('sales.create') }}"
                class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 no-underline">
            ...
            <div class="flex flex-col md:flex-row gap-4">
                ...
                <form method="GET" action="{{ route('sales.index') }}" class="flex-1">
                    <div class="flex flex-col md:flex-row gap-3">
                        ...
                        <button type="submit"
                            class="mt-auto bg-blue-600 text-white px-6 py-2 rounded-lg shadow hover:bg-blue-700 transition-colors">
                            Search
                        </button>
                    </div>
                </form>
                ...
                <form action="{{ route('items.exportSalesCSV') }}" method="GET" class="flex flex-col md:flex-row gap-3">
                    ...
                    <button type="submit"
                        class="mt-auto bg-green-600 text-white px-6 py-2 rounded-lg shadow hover:bg-green-700 transition-colors flex items-center justify-center gap-2">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                <a href="{{ route('sales.show', $sale->id) }}"
                                    class="bg-blue-600 text-white px-4 py-2 rounded-md shadow hover:bg-blue-700 no-underline">
                                    View
                                </a>

                                <!-- Refund Button -->
                                @if($sale->refund_status === 'no_refund')
                                <a href="{{ route('refund.create', $sale->id) }}"
                                    class="bg-yellow-500 text-white px-4 py-2 rounded-md shadow hover:bg-yellow-600 no-underline">
                                    Refund
                                </a>
