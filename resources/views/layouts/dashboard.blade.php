                                    ...
                                    @foreach ($refundMetrics['recent_refunds'] as $refund)
                                        <div
                                            ...
                                            <div class="flex flex-col">
                                                ...
                                                <span
                                                    class="text-sm text-gray-500 font-medium">{{ $refund->item->name }}</span>
                                            </div>
                                            <div class="text-right">
                                                <span
                                                    class="font-bold text-red-600">{{ number_format($refund->refund_amount, 2) }}
                                                    EGP</span>
                                ...
                                @foreach ($topSellingBrandDetails as $index => $brand)
                                    <div
                                        ...
                                        <div class="flex items-center space-x-4">
                                            ...
                                            @else
                                                <div
                                                    class="w-12 h-12 rounded-lg bg-gray-100 flex items-center justify-center border-2
                                                 @if ($index == 0) border-yellow-400
                                                 @elseif($index == 1) border-gray-400
                                                 @elseif($index == 2) border-orange-600
                                                 @else border-gray-100 @endif">
                                            ...
                                            <div class="flex flex-col">
                                                <span
                                                    class="text-lg font-semibold text-gray-900">{{ $brand['name'] }}</span>
                    ...
                    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                        <div class="border-b border-gray-100 p-6">
                            <div class="flex items-center justify-between">
                                ...
                                <span
                                    class="px-3 py-1 text-sm font-medium text-emerald-700 bg-emerald-50 rounded-full">
                                    Last 30 Days
                                </span>
                            </div>
                        </div>
                        ...
                        <div x-show="isOpen" x-transition>
                            <div class="p-6">
                                    ...
                                    <div class="space-y-3 max-h-[400px] overflow-y-auto pr-2">
                                        @foreach ($lowStockItems->sortBy('quantity') as $item)
                                            <div
                                                ...
                                                <div class="flex flex-col">
                                                    <span
                                                        class="font-medium text-gray-900">{{ $item->name }}</span>
                                                    <div class="flex items-center space-x-2 mt-1">
                                                        ...
                                                        <span
                                                            class="text-sm text-red-400 font-medium">{{ $item->quantity }}
                                                            left</span>
                                                    </div>
                                                </div>
                                ...
                                @else
                                    <div class="flex flex-col items-center justify-center py-8 px-4">
                                        <div
                                            class="h-12 w-12 rounded-full bg-green-100 flex items-center justify-center mb-3">
                                            <i class="fas fa-check text-green-500 text-xl"></i>
                                        </div>
