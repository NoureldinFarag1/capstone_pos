                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:space-x-4">
                            ...
                            <a href="<?php echo e(route('dashboard')); ?>" class="text-gray-600 hover:bg-gray-100 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium transition-colors">
                            ...
                            <div x-data="{ open: false }" class="relative">
                                ...
                                >
                                    <div class="py-1 bg-white rounded-md shadow-xs">
                                        <a href="<?php echo e(route('items.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                            <i class="fas fa-box mr-2"></i>Items
                                        </a>
                                        <a href="<?php echo e(route('brands.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                            <i class="fas fa-tags mr-2"></i>Brands
                                        </a>
                                        <a href="<?php echo e(route('categories.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                            <i class="fas fa-th-list mr-2"></i>Categories
                                        </a>
                                        <a href="<?php echo e(route('sizes.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                            <i class="fas fa-ruler mr-2"></i>Sizes
                                        </a>
                                        <a href="<?php echo e(route('colors.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                            ...
                            <div x-data="{ open: false }" class="relative">
                                ...
                                >
                                    <div class="py-1 bg-white rounded-md shadow-xs">
                                        <a href="<?php echo e(route('sales.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                            <i class="fas fa-list mr-2"></i>Sales List
                                        </a>
                                        <a href="<?php echo e(route('sales.create')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin')): ?>
                                <a href="<?php echo e(route('users.index')); ?>" class="text-gray-600 hover:bg-gray-100 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium transition-colors">
                    ...
                    <div class="hidden sm:flex sm:items-center">
                        ...
                        <li class="nav-item dropdown me-3" style="list-style-type: none;">
                            <a class="nav-link position-relative" href="#" id="lowStockDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <?php if(count($lowStockItems) > 0): ?>
                                    <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
                                        <?php echo e(count($lowStockItems)); ?>
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="lowStockDropdown">
                                ...
                                <?php $__currentLoopData = $lowStockItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a class="dropdown-item" href="<?php echo e(route('items.edit', $item->id)); ?>">
                        ...
                        <div>
                            ...
                            <span>(<?php echo e($user->getRoleNames()->first() ?? 'Role not assigned'); ?>)</span>
                        </div>
                            ...
                            <div class="relative z-10">
                                ...
                                <div class="bg-white/10 rounded-lg p-4">
                                    <div class="mb-2">
                                        ...
                                        <span class="float-right font-bold"><?php echo e(number_format($topPaymentMethodPercentage, 2)); ?>%</span>
                                    </div>
                        ...
                        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                            ...
                            <div class="p-6">
                                <?php if($lowStockItems->isNotEmpty()): ?>
                                    <div class="space-y-3">
                                        <?php $__currentLoopData = $lowStockItems->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="group flex justify-between items-center p-4 rounded-lg transition-all duration-300 hover:bg-gray-50 hover:shadow-sm">
                                                <div class="flex flex-col">
                                                    <span class="font-medium text-gray-900"><?php echo e($item->name); ?></span>
