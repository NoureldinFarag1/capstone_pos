...
<div class="container mx-auto py-8">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="<?php echo e(route('users.create')); ?>" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-6 rounded-lg shadow transition duration-200">
            + Create User
        </a>
    </div>
                        ...
                        <tr class="hover:bg-gray-50 transition duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                <span class="inline-block px-3 py-1 rounded-full text-xs font-semibold
                                    <?php echo e($user->hasRole('Admin') ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'); ?>">
                                    <?php echo e($user->getRoleNames()->implode(', ')); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-right space-x-2">
                                <a href="<?php echo e(route('users.edit', $user->id)); ?>" class="text-blue-600 hover:text-blue-800 font-semibold flex items-center space-x-1">
                                    <span>Edit</span>
                                ...
                                <form action="<?php echo e(route('users.destroy', $user->id)); ?>" method="POST" onsubmit="return confirm('Are you sure?');" class="inline">
                                    <?php echo csrf_field(); ?>
