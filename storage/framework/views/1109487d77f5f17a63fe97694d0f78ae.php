...
<div class="container mx-auto py-6 px-4">
    <h3 class="text-2xl font-bold mb-6">Refund for Sale #<?php echo e($sale->id); ?></h3>

    <form action="<?php echo e(route('refund.store')); ?>" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <?php echo csrf_field(); ?>
        ...
        <table class="min-w-full bg-white">
            ...
            <tbody>
                <?php $__currentLoopData = $saleItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $saleItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500">
                        <?php echo e($saleItem->item->name); ?>
                    ...
                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500">
                        <input
                            type="number"
                            name="refund[<?php echo e($saleItem->id); ?>][quantity]"
                            min="0"
                            max="<?php echo e($saleItem->quantity); ?>"
                            value="0"
                    ...
                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500">
                        <input
                            type="text"
                            name="refund[<?php echo e($saleItem->id); ?>][reason]"
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/noureldinfarag/capstone_pos/resources/views/refund/create.blade.php ENDPATH**/ ?>