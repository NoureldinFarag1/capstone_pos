...
<div class="container mx-auto py-8">
    ...
    <form action="<?php echo e(route('users.store')); ?>" method="POST" class="bg-white shadow-lg rounded-lg px-8 pt-6 pb-8 mb-4 space-y-6">
        <?php echo csrf_field(); ?>
        <?php if($errors->any()): ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/noureldinfarag/capstone_pos/resources/views/users/create.blade.php ENDPATH**/ ?>